export function PaletteC() {
  ...
  return (
    <div style={{ display: "flex", width: "100%", height: "100vh", fontFamily: "Inter, sans-serif" }}>
      ...
      <div style={{ width: 2, background: "#10b981" }} />
  ...
  return (
    <div style={{ flex: 1, display: "flex", flexDirection: "column", background: t.bg, overflow: "hidden" }}>
        ...
        <div style={{ width: 200, background: t.sidebar, display: "flex", flexDirection: "column", flexShrink: 0 }}>
          <div style={{ padding: "20px 16px 12px", borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              ...
              <div>
                <div style={{ color: "#fafafa", fontSize: 12, fontWeight: 700, letterSpacing: "0.02em" }}>LAFER</div>
          ...
          <div style={{ padding: "12px 16px", borderTop: "1px solid rgba(255,255,255,0.05)" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              <div style={{ width: 28, height: 28, borderRadius: "50%", background: `${t.accent}20`, border: `1px solid ${t.accent}40`, display: "flex", alignItems: "center", justifyContent: "center" }}>
                <span style={{ color: t.sidebarActive, fontSize: 11, fontWeight: 700 }}>JB</span>
              </div>
              <div>
                <div style={{ color: "#fafafa", fontSize: 11, fontWeight: 600 }}>João Batista</div>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden" }}>
          <div style={{ background: t.header, borderBottom: `1px solid ${t.headerBorder}`, padding: "12px 20px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            ...
            <div style={{ display: "flex", gap: 8 }}>
              ...
              <div style={{ padding: "5px 12px", borderRadius: 5, background: t.accent, fontSize: 11, fontWeight: 600, color: "#ffffff" }}>Exportar</div>
            </div>
          </div>
              ...
              <div style={{ display: "flex", alignItems: "flex-end", gap: 6, height: 80 }}>
                {bars.map((h, i) => (
                  <div key={i} style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", gap: 4 }}>
                    <div style={{ width: "100%", borderRadius: "3px 3px 0 0", background: i === 2 ? t.chart1 : `${t.chart1}45`, height: `${h}%` }} />
      ...
      <div style={{ background: t.accent, padding: "5px 16px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <span style={{ fontSize: 10, color: "rgba(255,255,255,0.6)" }}>C — Carbon & Emerald · Bold</span>
      </div>
    </div>
  );
}
